            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="background-color:#171717;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a target="_blank" href="<?php echo e(route('eventReg')); ?>" class="btn btn-primary">Register Now!</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="background-color:#171717;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a target="_blank" href="<?php echo e(route('eventReg')); ?>"
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-9 mx-auto text-center">
                            <div>
                                <br><br>
                                <h1 class=""><img src="<?php echo e(asset('theme/images/collegelogo.webp')); ?>" alt="Pragyotsav2022" id="abcde"></h1>
                                <h1 class=""><img src="<?php echo e(asset('theme/images/ietelogo.webp')); ?>" id="fghjkl"></h1>
                                <h1>
                                    <img class="qwert" src="<?php echo e(asset('theme/images/25logo.webp')); ?>">
                                </h1>


                            </div>

                            <h1 class="heading"><img src="<?php echo e(asset('theme/images/titlelogo.webp')); ?>"
            ...
            <div class="unslate_co--section" id="workshop-section">
                <div class="container">
                    ...
                    <div class="row gutter-v3">
                            ...
                            <a data-toggle="modal" data-target="#racing">
                                <div class="feature-v1 " data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/printing.jpg')); ?>" alt="Icon" style="width: 100%"/>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#drone">
                                <div class="feature-v1 " data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/drone.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#war">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/robowar.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                    ...
                    <div class="section-heading-wrap text-center mb-5">
                        ...
                        <div class="wrapper">
                            <a class="cta" target="_blank" href="<?php echo e(route('eventReg')); ?>">
                    ...
                    <div class="row gutter-v3">
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#racing">
                                <div class="feature-v1 " data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/roboracing.jpg')); ?>" alt="Icon" style="width: 100%"/>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#hardware">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/hardware.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#soldering">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/soldering.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#follower">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/linefollow.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#presentation">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/presentation.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#soccer">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/soccer.jpg')); ?>" alt="Icon"
                                             width="100%"/>
                                    </div>
                        ...
                        <!-- <div class="col-md-6 col-lg-4 mb-4 listing-item">
                            <a data-toggle="modal" data-target="#painting">
                                <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
                                    <div class="wrap-icon mb-3">
                                        <img src="<?php echo e(asset('theme/images/printing.jpg')); ?>" alt="Icon"
                                             width="100%">
                                    </div>
                    ...
                    <div class="row gutter-v4 align-items-stretch">
                        <div class="col-sm-6 col-md-6 col-lg-8 blog-post-entry" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <a class="grid-item blog-item w-100 h-100">
                                ...
                                <img src="<?php echo e(asset('theme/images/IMG_0416.JPG')); ?>" class="lazyload"
                                     alt="Image"/>
                            </a>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 blog-post-entry" data-aos="fade-up" data-aos-delay="100">
                            <a class="grid-item blog-item w-100 h-100">
                                ...
                                <img src="<?php echo e(asset('theme/images/IMG_1834.JPG')); ?>" class="lazyload"
                                     alt="Image"/>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 blog-post-entry" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <a class="grid-item blog-item w-100 h-100">
                                ...
                                <img src="<?php echo e(asset('theme/images/IMG_0349.JPG')); ?>" class="lazyload"
                                     alt="Image"/>
                            </a>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 blog-post-entry" data-aos="fade-up" data-aos-delay="100">
                            <a class="grid-item blog-item w-100 h-100">
                                ...
                                <img src="<?php echo e(asset('theme/images/vjs1.png')); ?>" class="lazyload"
                                     alt="Image"/>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 blog-post-entry" data-aos="fade-up" data-aos-delay="200">
                            <a class="grid-item blog-item w-100 h-100">
                                ...
                                <img src="<?php echo e(asset('theme/images/vjs2.png')); ?>" class="lazyload"
                                     alt="Image"/>
                            </a>
                        </div>
            ...
            <div class="unslate_co--section" style="background: radial-gradient(#141414 ,BLACK);"
                ...
                <span class="row gasp-reveal">
                    <div class="column" style="text-align: center;">
                        <figure>
                            <img src="<?php echo e(asset('theme/images/iniya.jpg')); ?>" class="lazyload   img-fluid"
                                 alt="Images"/>
                    ...
                    <div class="column">
                        <figure style="text-align: center;">
                            <img src="<?php echo e(asset('theme/images/akshaya.jpg')); ?>" class="lazyload   img-fluid"
                                 alt="Images"/>
                            <figcaption style="text-align: center;">
                    ...
                    <div class="column">
                        <figure style="text-align: center;">
                            <img src="<?php echo e(asset('theme/images/keshav.jpg')); ?>" class="lazyload  img-fluid"
                                 alt="Images"/>
                            <figcaption style="text-align: center;">
                    ...
                    <div class="column">
                        <figure style="text-align: center;">
                            <img src="<?php echo e(asset('theme/images/vishwa.jpg')); ?>" class="lazyload    img-fluid"
                                 alt="Images"/>
                            <figcaption style="text-align: center;">
                    ...
                    <div class="column" style="text-align: center;">
                        <figure style="text-align: center;">
                            <img src="<?php echo e(asset('theme/images/swetha.jpg')); ?>" class="lazyload   "
                                 alt="Images"/>
                            <figcaption style="text-align: center;">
            ...
            <div class="unslate_co--section" style="background: radial-gradient(#141414 ,BLACK);" id="contact-section">
                <div class="container">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6">
                            <form method="post" class="form-outline-style-v1" action="<?php echo e(route('contact')); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="contact-info-v1">
                                ...
                                <div class="gsap-reveal d-block">
                                    <a target="_blank" href="https://www.instagram.com/pragyotsav_2022/"><span
                                                class="d-block contact-info-label">Follow Us @ <img class="fab" style="width: 23.8px; height: 23px;margin-top: -6.9px;" src="<?php echo e(asset('theme/images/instagram.png')); ?>"></span>
                                    </a></label>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pragyotsav\resources\views/frontend/index.blade.php ENDPATH**/ ?>